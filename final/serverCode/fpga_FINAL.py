...
class Ball:
    ...
    def __init__(self, x = size[0]/2, y = size[1]/2, xspeed = -random.randrange(5,8), yspeed = random.randrange(5,8)):
        self.x = x
        self.y = y
        self.xlast = x-xspeed
        self.ylast = y-yspeed
    ...
    def reset(self, x = size[0]/2, y = size[1]/2):
        ...
        self.xspeed = random.choice([-1, 1]) * 6
        self.yspeed = random.choice([-1, 1]) * 6
...
def update_game(client, action):
    ...
    if (flag):
        ...
        if client == "1": 
            myPaddle1.xspeed = accelerometer_val * 3
        if client == "2":
            myPaddle2.xspeed = accelerometer_val * 3
