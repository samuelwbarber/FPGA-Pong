...
def draw(paddle1_y, paddle2_y, ball_x, ball_y):
    ...
    pygame.draw.rect(screen, BLACK, [size[0]-20, paddle2_y, 20, 100])  # Outer rectangle
    pygame.draw.rect(screen, RED, [size[0]-22, paddle2_y+2, 20-4, 100-4])  # Inner rectangle
...
asyncio.get_event_loop().run_until_complete(player2())
