...
def draw(paddle1_x, paddle2_x, ball_x, ball_y, paddle1_score, paddle2_score, client = 0):
    print("draw" + client)
...
async def play():
   uri = "ws://ec2-18-130-242-91.eu-west-2.compute.amazonaws.com:6789"
   message = 0
   print("here")
