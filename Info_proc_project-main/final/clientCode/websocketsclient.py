...
def draw(paddle_y, ball_x, ball_y, ):
    screen.fill(FILL)
    pygame.draw.rect(screen, BLACK, [0, paddle_y, 20, 100])  # Outer rectangle
    pygame.draw.rect(screen, RED, [2, paddle_y+2, 20-4, 100-4])  # Inner rectangle
...
def decode(message):
    ...
    draw(parameters[0], parameters[1], parameters[2])
